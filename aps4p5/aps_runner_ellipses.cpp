...
aps_test.set_timingname("aps_output/timing_file_ellipses_onion_p5.sav");
aps_test.set_outname("aps_output/master_output_ellipses_onion_p5.sav");
...
i=-1;
while(aps_test.get_called()<40000){
    aps_test.search();    
}
